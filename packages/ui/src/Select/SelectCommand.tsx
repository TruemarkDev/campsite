...
>(({ ...props }, ref) => (
  <div className='flex items-center px-2.5 pt-1'>
    ...
    <CommandPrimitive.Input
      ref={ref}
      className='h-8 w-full border-0 bg-transparent px-2 py-3 text-sm text-[15px] placeholder-gray-400 outline-none focus:border-black/5 focus:ring-0 disabled:cursor-not-allowed disabled:opacity-50'
      {...props}
    />
  </div>
))
