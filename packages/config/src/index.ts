...
const environmentUrl = (value: string | undefined, productionDefault: string, developmentDefault: string) =>
  value || (IS_PRODUCTION ? productionDefault : developmentDefault)
...
export const WEB_URL = environmentUrl(process.env.NEXT_PUBLIC_WEB_URL, WEB_URL_PROD, WEB_URL_DEV)
export const SITE_URL = environmentUrl(process.env.NEXT_PUBLIC_SITE_URL, SITE_URL_PROD, SITE_URL_DEV)
export const SYNC_URL = environmentUrl(process.env.NEXT_PUBLIC_SYNC_URL, SYNC_URL_PROD, SYNC_URL_DEV)
