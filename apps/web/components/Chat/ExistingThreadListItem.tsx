...
import { Link, RelativeTime, UIText } from '@campsite/ui'
...
export function ExistingThreadListItem({ thread, isSelected = false }: Props) {
  ...
  return (
    <Link
      ...
      className={cn(
        'dark:focus:bg-tertiary group relative flex w-full flex-none scroll-mt-12 items-center gap-3 rounded-lg py-3 pr-4 pl-2 focus-within:border-none focus-within:ring-0 focus-within:outline-none focus:border-none focus:ring-0 focus:outline-none',
        {
