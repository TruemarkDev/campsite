...
export function OrganizationSwitcher({ trigger }: { trigger?: React.ReactNode }) {
  ...
  const defaultTrigger = (
    <button className='hover:bg-quaternary relative flex cursor-pointer items-center justify-between gap-2 overflow-hidden rounded-md p-1.5 text-sm focus-visible:border-blue-500 focus-visible:ring-2 focus-visible:ring-blue-100 focus-visible:outline-none'>
