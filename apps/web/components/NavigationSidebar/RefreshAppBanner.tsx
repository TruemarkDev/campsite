...
import { RefreshIcon, UIText } from '@campsite/ui'
    ...
    <AnimatePresence>
      {isVisible && (
        ...
        >
          ...
          >
            <div className='bg-elevated text-primary flex items-center gap-1.5 rounded-full py-0.5 pr-3 pl-2 shadow-sm ring-1 ring-black/5 transition-all hover:shadow-md dark:bg-gray-800'>
