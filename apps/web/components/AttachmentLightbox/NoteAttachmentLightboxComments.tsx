...
import { Attachment, Note } from '@campsite/types'
...
function OuterContainer({ children, isOpen, width }: { children: React.ReactNode; isOpen: boolean; width: string }) {
  return (
    <m.aside
      ...
      className={cn(
        '4xl:max-w-[500px] flex flex-none flex-col border-t focus:ring-0 focus:outline-none lg:w-full lg:max-w-[400px] lg:border-t-0 lg:border-l',
        {
          invisible: !isOpen
        }
      )}
