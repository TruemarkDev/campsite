...
export function NotePreviewCard({ className, noteId, interactive = true }: Props) {
  ...
  return (
    <div
      className={cn(
        'bg-elevated hover:bg-secondary hover:border-primary group/note relative flex w-full max-w-lg flex-1 overflow-clip rounded-lg border focus:ring-0 focus:outline-none',
        className
      )}
    >
