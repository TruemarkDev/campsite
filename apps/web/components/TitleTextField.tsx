...
import { TextareaAutosize } from '@campsite/ui/TextField'
...
export const TitleTextField = forwardRef<HTMLTextAreaElement, Props>(function TitleTextField(props, outerRef) {
  ...
  return (
    <TextareaAutosize
      ref={ref}
      className={cn(
        'scrollbar-hide w-full shrink-0 resize-none rounded-none border-0 bg-transparent p-0 outline-none focus:border-0 focus:ring-0 focus:outline-none dark:bg-transparent',
        className
      )}
