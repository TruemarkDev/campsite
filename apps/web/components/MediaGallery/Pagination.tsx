...
import { MediaGalleryItemAttributes } from '@campsite/editor/extensions'
import { Button, ChevronLeftIcon, ChevronRightIcon, LoadingSpinner, PlusIcon, ThickCloseIcon } from '@campsite/ui'
