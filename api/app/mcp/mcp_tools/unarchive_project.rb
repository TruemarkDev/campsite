...
module McpTools
  class UnarchiveProject < McpTool
    tool_name "unarchive_project"
    description "Restore an archived project. Requires write_project and unarchive permission."
    ...
    def execute
      ...
      authorize!(actor, project, :unarchive?)
      project.unarchive! if project.archived?
